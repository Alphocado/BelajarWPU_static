...
@section('container')
    ...
    <div class="col-md-6">
      ...
      <form action="/blogs">
        ...
        <div class="input-group mb-3">
          {{-- ada value biar saat tekan submit tidak terhapus --}}
  ...
  {{-- jika ada postingan --}}
  {{-- menampilkan post pertama dan jadikan highlight --}}
  @if($posts->count())
  <div class="card mb-3">
    ...
    <div class="card-body text-center">
      ...
      <p>
        <small class="text-muted">
          By. <a href="/blogs?author={{ $posts[0]->author->username }}" class="text-decoration-none">{{ $posts[0]->author->name }}</a> in 
          <a href="/blogs?category={{ $posts[0]->category->slug }}" class="text-decoration-none">
  ...
  {{-- sisa post, skip post pertama karena muncul diatas --}}
  <div class="container">
    <div class="row">
      ...
      <div class="col-md-4 mb-3">
        <div class="card">
          ...
          <div class="card-body">
            ...
            <p>
              <small class="text-muted">
                By. <a href="/blogs?author={{ $posts[0]->author->username }}" class="text-decoration-none">{{ $post->author->name }}</a> {{ $posts[0]->created_at->diffForHumans() }}
              </small>
            </p>
